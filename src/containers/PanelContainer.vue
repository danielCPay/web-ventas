          ...
          <div class="d-flex">
            ...
            <a class="logo-horizontal" to="/">
              <div class="text-center" id="id_contenedor_header">
                ...
                <h5 class="store-name">{{ nombreTienda }}</h5>
              </div>
            </a>
            <!-- LOGO -->
                  ...
                  <div class="d-flex order-lg-2">
                    ...
                    <div class="dropdown d-flex message">
                      <a class="nav-link icon text-center" data-bs-toggle="dropdown">
                        <i class="fe fe-message-square"></i><span :class="notificationList.length > 0 ? 'pulse-danger' : ''
                          "></span>
                      </a>
                      <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                        <div class="drop-heading border-bottom">
                        ...
                        <div class="message-menu">
                          <a class="dropdown-item d-flex" href="javascript:void(0)"
                            ...
                            <div class="wd-90p">
                              <div class="d-flex">
                                <h5 class="mb-1">{{ usuario.usuario }}</h5>
                                <small class="text-muted ms-auto text-end">
                                  {{ item.notification.fecha }}
                                </small>
                              </div>
                              <span>Mesa: {{ item.notification.mesa }}</span>
                            </div>
                          </a>
                        </div>
                        <div class="dropdown-divider m-0"></div>
                    ...
                    <div class="dropdown d-flex profile-1">
                      ...
                      <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                        ...
                        <a class="dropdown-item" href="javascript:void(0)" @click="cerrarSesion()">
                          <i class="dropdown-icon fe fe-alert-circle"></i> Sign
                          out
                        </a>
                      </div>
                    </div>
        ...
        <div class="app-sidebar">
          ...
          <div class="main-sidemenu">
            ...
            <ul class="side-menu">
              ...
              <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                    class="side-menu__icon fe fe-cpu"></i><span class="side-menu__label">Mantenedores</span><i
                    class="angle fe fe-chevron-right"></i></a>
                <ul class="slide-menu" style="display: none">
                  <li class="slide-item">
                    <router-link to="/mantenedores/subfamilia">Sub Familia</router-link>
                  </li>
                  <li class="slide-item">
                  ...
                  <li class="slide-item">
                    <router-link to="/mantenedores/cliente">Clientes</router-link>
                  </li>
                  <li class="slide-item">
                    <router-link to="/mantenedores/personal">Personal</router-link>
                  </li>
                </ul>
              </li>
              <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                    class="side-menu__icon fe fe-layers"></i><span class="side-menu__label">Caja</span><i
                    class="angle fe fe-chevron-right"></i></a>
                <ul class="slide-menu" style="display: none">
                  <li class="slide-item">
                    <router-link to="/cajachica/caja">Apertura Caja</router-link>
                  </li>
                  <li class="slide-item">
                    <router-link to="/cajachica/gastos">Gastos </router-link>
                  </li>
                  <li class="slide-item">
                    <router-link to="/cajachica/resumencaja">Resumen de Caja
                    </router-link>
                  </li>
                </ul>
              </li>
              <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                    class="side-menu__icon fe fe-shopping-bag"></i><span class="side-menu__label">Ventas</span><i
                    class="angle fe fe-chevron-right"></i></a>
                <ul class="slide-menu" style="display: none">
                  <li class="slide-item">
                  ...
                  <li class="slide-item">
                    <router-link to="/cajachica/resumencaja">Resumen de Ventas
                    </router-link>
                  </li>
                </ul>
              </li>
              <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                    class="side-menu__icon fe fe-shopping-cart"></i><span class="side-menu__label">Compras</span><i
                    class="angle fe fe-chevron-right"></i></a>
                <ul class="slide-menu" style="display: none">
                  <li class="slide-item">
                    <router-link to="/compras/modulocompras">Modulo de Compras</router-link>
                  </li>
                </ul>
              </li>
              <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                    class="side-menu__icon fe fe-truck"></i><span class="side-menu__label">Almacén</span><i
                    class="angle fe fe-chevron-right"></i></a>
                <ul class="slide-menu" style="display: none">
                  <li class="slide-item">
                    <router-link to="/almacen/notaingreso">Nota de Ingreso</router-link>
                  </li>
                  <li class="slide-item">
                    <router-link to="/almacen/notasalida">Nota de Salida</router-link>
                  </li>
                  <li class="slide-item">
                    <router-link to="/almacen/stockproductos">Stock de Productos</router-link>
                  </li>
                  <!-- <li class="slide-item">
                    <router-link to="/almacen/movimientosalmacen"
                      >Movimientos Almacén</router-link
                    >
                  </li> -->
                </ul>
              </li>
            ...
            <ul class="side-menu">
              ...
              <li class="slide">
                <router-link class="side-menu__item" data-bs-toggle="slide" to="">
                  <i class="side-menu__icon icon icon-lock-open"></i>
                  <span class="side-menu__label"> Cambiar Contraseña </span>
                </router-link>
              </li>
              <li class="slide">
                <router-link class="side-menu__item" data-bs-toggle="slide" to="/logout">
                  <i class="side-menu__icon icon icon-lock-open"></i>
        ...
        <div class="panel-body tabs-menu-body latest-tasks p-0 border-0">
          <div class="tabs-menu border-bottom">
            ...
            <ul class="nav panel-tabs">
              <li class="">
                <a href="#side1" class="active" data-bs-toggle="tab"><i class="fe fe-settings me-1"></i>Feeds</a>
              </li>
              <li>
                <a href="#side2" data-bs-toggle="tab"><i class="fe fe-message-circle"></i> Chat</a>
              </li>
              <li>
                <a href="#side3" data-bs-toggle="tab"><i class="fe fe-anchor me-1"></i>Timeline</a>
              </li>
            </ul>
          </div>
                ...
                <li class="d-sm-flex mt-4">
                  <div>
                    ...
                    <p class="text-muted fs-12">
                      Adam Berry finished task on<a href="javascript:void(0)" class="fw-semibold">
...
<script>
import CartProductos from "../components/pedidos/CartProductos.vue";
import { mapState } from "vuex";

export default {
  name: "PanelContainer",
  components: { CartProductos },
  data() {
    return {
      usuario: {},
  ...
  mounted() {
    ...
    if (tienda === "1") {
      this.nombreTienda = "🛒 Tienda Central";
    } else if (tienda === "2") {
      this.nombreTienda = "🏬 Segunda Tienda";
    } else {
      this.nombreTienda = "❓ Desconocida";
    }
  },
  created() {
